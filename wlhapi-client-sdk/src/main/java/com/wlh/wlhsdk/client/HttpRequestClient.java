...
public class HttpRequestClient {
    ...
    private final static String API_Host = "http://localhost:8098/";
    ...
    public String getNameByGet(String name) {
        return HttpUtil.get(API_Host+"api/name/" +name);
    }
    ...
    public String getNameByPost(String name){
        ...
        return HttpUtil.post(API_Host+"api/name" ,paramMap);
    }
    public String getNameByPostWithJson(User user) throws UnsupportedEncodingException {
        String json = JSONUtil.toJsonStr(user);
        HttpResponse response = HttpRequest.post(API_Host+"api/name/user")
